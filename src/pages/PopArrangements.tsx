  ...
  <div className="w-full">
    ...
    <div className="flex flex-col justify-center gap-12 py-12 mx-auto max-w-7xl">
      ...
      <div className="px-8 text-xl">
        ...
        of England, who performed public and private gigs between 2005 and 2012.
        All arrangements are written for Vocals (Male/Female, Lead/Backing), 3
        horns (Trumpet, Alto/Tenor Sax, Trombone), Keyboard, Guitar, Bass Guitar
        and Drums, unless stated otherwise. Arrangements cost £30 for a PDF
        download of all parts plus a full score.
      </div>
      <div className="px-8 text-xl">
